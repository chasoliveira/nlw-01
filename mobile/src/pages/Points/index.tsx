...
const Points = () => {
  ...
  useEffect(() => {
    const loadPosition = async () => {
      ...
      if (status !== "granted")
        Alert.alert(
          "Ooops..!",
          "Precisamos de sua permissão para obter a localicação"
        );
  ...
  const onDetailNavigateHandler = (id: number) => {
    navigation.navigate("Detail", { point_id: id });
  };

  const onItemPressHandler = (id: number) => {
            ...
            >
              {points.map((point) => (
                <Marker
                  ...
                  onPress={() => onDetailNavigateHandler(point.id)}
                  coordinate={{
